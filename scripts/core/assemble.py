#!/usr/bin/env python3
"""
Page assembly and CBZ creation for D&D Graphic Novel.
...
def create_cbz(pages_data, output_file=None, title="D&D Graphic Novel", series="D&D Graphic Novel"):
...
Examples:
  ...
  python assemble.py 1 --cleanup-variants # Assemble and delete variant files
    ...
    print("=" * 60)
    print("D&D GRAPHIC NOVEL PAGE ASSEMBLY")
    print("=" * 60)
